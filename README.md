...
A jekyll-based markdown CV, forked from [Ben Moore's fork](https://github.com/blmoore/md-cv) of the (great) markdown CV of [elipapa](https://github.com/elipapa/markdown-cv). Ben's original README below.
